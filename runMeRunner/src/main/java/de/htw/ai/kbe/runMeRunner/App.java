...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		/**
		 * Parser parser = new Parser(); parser.parseCLI(args);
		 * 
		 * String myClassName = ""; Properties properties = null;
		 * 
		 * try { properties = PropsFileUtil.readPropsFile(parser.getPropsFileName());
		 * 
		 * if(!properties.containsKey(CLASS_KEY_NAME)) { throw new
		 * Exception("'classToLoad' ist nicht gefunden!"); }
		 * 
		 * } catch (PropsReadException e) { //throw new Exception("'classToLoad' ist
		 * nicht gefunden!"); }
		 * 
